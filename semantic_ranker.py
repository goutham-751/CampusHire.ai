...
def calculate_match_score(resume_profile: str, job_description: str) -> float:
...
if __name__ == '__main__':
    ...
    """
    resume_profile_info = create_resume_profile(sample_resume_data)
    print("--- Generated Resume Profile ---")
    print(resume_profile_info)
    print("-" * 30)
    
    # Matching score
    score = calculate_match_score(resume_profile_info, sample_job_description)
